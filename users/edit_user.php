                ...
                <div class="card-body">
                    <form action="update_user.php" method="POST" enctype="multipart/form-data">
                        ...
                        <select name="role" class="form-control">
                            ...
                            <option <?php echo ($after_assoc['role'] == 1 ? 'selected':'')?> value="1">ADMIN</option>
                            <option <?php echo ($after_assoc['role'] == 2 ? 'selected':'')?> value="2">MODERATOR</option>
                            <option <?php echo ($after_assoc['role'] == 3 ? 'selected':'')?> value="3">EDITOR</option>
                            <option <?php echo ($after_assoc['role'] == 0 ? 'selected':'')?> value="0">VISITOR</option>
                        </select>
                    </div>
                        <div class="mb-3">
