                    ...
                    <div class="col-xl-9 col-lg-10">
                        <div class="single-blog-list">
                            <div class="blog-list-thumb mb-35">
                                <img src="uploads/works/<?= $after_assoc['project_image'] ?>" alt="img">
                            </div>
                            ...
                            <div class="avatar-post mt-70 mb-60">
                                ...
                                $afteer_assoc_user = mysqli_fetch_assoc($user_result);
                                ?>
                                <ul>
                                    <li>
                                        <div class="post-avatar-img">
                                            <img width="50" src="uploads/user/<?= $afteer_assoc_user['profile_photo'] ?>" alt="img">
                                        </div>
                                        <div class="post-avatar-content">

                                            <h5><?= $afteer_assoc_user['name'] ?></h5>
