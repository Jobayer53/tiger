    ...
    <header>
                    ...
                    <div class="col-xl-12">
                        <div class="main-menu">
                            <nav class="navbar navbar-expand-lg">
                                <a href="index.php" class="navbar-brand logo-sticky-none"><img src="uploads/logo/Untitled-1.png" alt="Logo"></a>
                                <a href="index.php" class="navbar-brand s-logo-none"><img src="uploads/logo/Untitled-2.png" alt="Logo"></a>
        ...
        <div class="extra-info">
            ...
            <div class="logo-side mb-30">
                <a href="index.php">
                    <img src="uploads/logo/Untitled-1.png" alt="" />
                </a>
            </div>
                            ...
                            <div class="col-lg-4 col-md-6 pitem">
                                <div class="speaker-box">
                                    ...
                                    <div class="speaker-overlay">
                                        ...
                                        <h4><a href="portfolio-single.html"><?= $work['project_name'] ?></a></h4>
